...
<nav class="navbar navbar-expand-lg navbar-light bg-secondary">
  ...
  <img src="imagen5.jpg" alt="" width="80" height="80">  
...
<div class="row">
    <div class="col-md-12">
        <h2 class="mt-4">Eliminar Registro Busqueda De Equipo</h2>
    ...
    if($_POST){
        ...
        if($resultado){
          ...
          while($row = mysqli_fetch_assoc($resultado)){
            ...
            "</td><td><a href='delete2.php?id=".$row["Id"]."&equipo=".$row["Equipo"]."&rival=".$row["Rival"]."&tiempo=".$row["Tiempo"]."&hora=".$row["Hora"]."&estado=".$row["Estado"]." 'class='btn btn-danger'>Eliminar</a></td>";
          }
          echo "</tbody>
          </table>";        
        }else{
